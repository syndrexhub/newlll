...
setenv FRIENDLY_NAME "Squidvpn OHP"
client
dev tun
proto tcp
remote "bug" 1194
...
[Unit]
Description=Direct Squid Proxy For OpenVPN TCP By Squidvpn
Documentation=https://Squidvpn
Documentation=https://t.me/Squidvpn
